#!/bin/bash
#
# Run transfer-aware hyperparameter search
#
# This script launches the Optuna-based hyperparameter optimization
# that finds the best Stage 1 hyperparameters for Stage 2 transferability.
#
# Usage:
#   bash scripts/run_hparam_search.sh [OPTIONS]
#
# Options:
...
# Print configuration
echo "=========================================="
echo "Transfer-Aware Hyperparameter Search"
echo "=========================================="
echo "Configuration:"
...
if [ $? -eq 0 ]; then
    ...
    echo
    echo "Next steps:"
    echo "  1. Check results/hparam_search/*/best_params.json"
    echo "  2. Update configs/config.yaml with best hyperparameters"
    echo "  3. Run full training with optimized hyperparameters"
else
    echo
    echo "=========================================="
